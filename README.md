...
*SHARDIK* is a REPL and interpreter for working with HermiT (and some other DL (OWL-API) reasoners) directly via a DSL for defining axioms (and/or loading OWL ontologies) and checking axioms for entailment and satisfiability. *SHARDIK* is built on the [*SHAR*](https://github.com/pseifer/shar) library
...
- The [SHAR](https://github.com/pseifer/shar) library
